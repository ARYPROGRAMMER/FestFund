...
export default function HomePage() {
  ...
  const handleConnectWallet = async (): Promise<boolean> => {
    try {
      // Add initial delay to prevent double-click issues
  ...
  const handleCampaignSelect = (campaign: Event) => {
    ...
    // Could open detailed view or navigate to campaign page
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case "create":
        return (
          <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-4">
